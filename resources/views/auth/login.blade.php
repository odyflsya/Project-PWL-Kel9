<x-guest-layout>
    ...
    <div class="">
        ...
        <form method="POST" action="{{ route('login') }}" class="form">
            ...
            <input class="register-button mt-4" type="submit" value="Log in">
        ...
        <div class="social-account-container">
            <span class="title">Or Sign I with</span>
        ...
        <a class="dont-have-account underline text-sm text-gray-600 hover:text-gray-900 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 mt-4" href="{{ route('register') }}">
